...
public class OrderedList_3Test {
    ...
    public void testAddAndFindIndex_withDuplicates() {
        ...
        // findIndex может вернуть любой индекс элемента
    ...
    // ==================== Тесты для findFirstIndex() и findLastIndex() ====================
    ...
    // ==================== Тесты для binary search complexity ====================
    ...
    public void testBinarySearch_largeList() {
        ...
        // Проверяем поиск первого, среднего и последнего элементов
        assertEquals(0, list.findIndex(1));
    ...
    public void testBinarySearch_withDuplicates_largeList() {
        ...
        // Добавляем элементы с дубликатами: 10 копий каждого числа от 0 до 99
        ...
        // Проверяем findFirstIndex и findLastIndex
